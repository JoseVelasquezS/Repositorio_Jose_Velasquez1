...

{
  ...
  #Description: Function for get pay obligation
  #Date:20/11/2020
  #Author:Cristian Malaver
  public function getPayObligation($code)
  {
    try {
      ...
      $con->query("SET NAMES 'utf8'");
      if ($con != null) {
        if ($result = $con->query("SELECT  pay_obligation_actual_cuote,pay_Date,pay_Dtf,pay_Ibr,pay_FixedRate,pay_value,pay_Dtf_points,pay_Ibr_points,pay_missing_cuotes,pay_interesting_value,pay_capital_value,
        ...
        OI.obligation_id,OCOD.obligation_cod,OCOD.client_idmax,OCOD.client_name,OCOD.client_contract 
                ...
                WHERE OCOD.obligation_cod = '$code'
  ...
  public function selectObligation($code)
  {
    try {
      ...
      if ($con != null) {
        if ($result = $con->query("SELECT *  FROM obligation WHERE obligation_cod='$code'")) {
