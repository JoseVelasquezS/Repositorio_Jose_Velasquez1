...
class Table {
    ...
    //**Method create Table Obligation **/
    createTableObligations() {
            ...
            for (let i = 0; i < this.jSon.length; i++) {
                ...
                objtbody += '<tr><td>' + this.jSon[i].obligation_cod + '</td><td>' + this.jSon[i].client_idmax + '</td><td>' + this.jSon[i].client_name + '</td><td>' + this.jSon[i].client_contract + '</td><td>' + this.jSon[i].Bank_name + '</td>' +
                    '<td><div class="btn-group" role="group" aria-label="Basic example">' +
                    '<button type="button" id="createAmortization" onclick="createAmortizationTable(' + "'" + this.jSon[i].obligation_cod + "' " + ');" class="btn btn-success"><i class="fas fa-table"></i></button>' +
                    ...
                    '<button type="button" onclick="getDelete(' + "'" + this.jSon[i].obligation_cod + "' " + ');clearForm(' + "'form_customers'" + ', 0);" class="btn btn-danger"><i class="fas fa-trash-alt"></i></button></div></td></tr>';
            }
            objtbody += '</tbody>';
            objThead += '</thead>';
            table = objThead + objtbody;
    ...
    createTablePayObligations() {
            ...
            for (let i = 0; i < this.jSon.length; i++) {
                ...
                objtbody += '<tr><td>' + this.jSon[i].obligation_cod + '</td><td>' + this.jSon[i].initial_value + '</td><td>' + this.jSon[i].cuotes_number + '</td><td>' + this.jSon[i].pay_missing_cuotes + '</td><td>' + this.jSon[i].pay_Date + '</td><td>' + this.jSon[i].pay_value + '</td><td>' + this.jSon[i].pay_value + '</td>' +
                    '<td><div class="btn-group" role="group" aria-label="Basic example">' +
                    '<button type="button" onclick="getPay(' + "'" + this.jSon[i].obligation_cod + "' " + ');clearForm(' + "'form_customers'" + ', 0);" class="btn btn-success"><i class="far fa-eye"></i></button>' +
                    '<button type="button" onclick="getDataEdit(' + "'" + this.jSon[i].obligation_cod + "' " + ');clearForm(' + "'form_customers'" + ', 0);"class="btn btn-primary"><i class="fas fa-table"></i></button>' +
                    '<button type="button" onclick="getDelete(' + "'" + this.jSon[i].obligation_cod + "' " + ');clearForm(' + "'form_customers'" + ', 0);" class="btn btn-danger"><i class="fas fa-trash-alt"></i></button></div></td></tr>';
            }
            objtbody += '</tbody>';
            objThead += '</thead>';
        ...
        //**Method create Table pay Obligation **/
