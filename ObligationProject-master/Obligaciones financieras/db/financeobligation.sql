...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-11-2020 a las 15:34:06
...
INSERT INTO `obligation` (`obligation_id`, `client_idmax`, `client_name`, `client_contract`, `Bank_id`, `credit_type_id`, `interesting_type_id`, `amortization_type_id`, `desembolso_date`, `initial_value`, `cuotes_number`, `residual_number`, `dtf`, `dtf_points`, `ibr`, `ibr_points`, `fixed_rate`, `Stat_id`, `obligation_cod`) VALUES
(18, '900939798', ' RENTING AUTOMAYOR', 'CA000000', 1, 1, 1, 1, '2020-10-31', 1111, 1, 1111, 1, 1, 0, 0, 0, 3, 'prueba1'),
(19, '830100710', ' AKAMON S.A', 'CA000117', 1, 1, 1, 1, '2019-11-30', 234, 4, 44, 4, 4, 0, 0, 0, 3, 'preuba2'),
(20, '900152407', ' SERTA COLOMBIA S.A.S.', 'FU013123', 3, 2, 3, 2, '2018-10-29', 615135, 15, 151, 0, 0, 0, 0, 51, 3, 'prueba3'),
(21, '900939798', ' RENTING AUTOMAYOR', 'CA000000', 1, 1, 1, 1, '2019-11-07', 0, 0, 0, 0, 0, 0, 0, 0, 3, 'prueba4'),
(22, '900177115', ' INVERSIONES LEAL MORA SA', 'FU006320', 1, 1, 1, 1, '2019-12-31', 231234000, 223, 23232, 22, 3, 0, 0, 0, 3, 'aaaa'),
(23, '830032902', ' AEROHELICES', 'FU002919', 1, 1, 1, 1, '2020-12-31', 45345300, 343, 34235300, 2, 23, 0, 0, 0, 3, 'asdsasd'),
(24, '800220285', ' LAVANSER SAS', 'CA005220', 1, 1, 1, 1, '2020-12-31', 4645630, 546, 455636, 2, 0, 0, 0, 0, 3, 'awdeadfasd'),
(25, '900177115', ' INVERSIONES LEAL MORA SA', 'FU003019', 1, 1, 1, 1, '2020-12-31', 1000000, 525, 561561, 1.434, 12, 0, 0, 0, 3, 'prueba10'),
(26, '900177115', ' INVERSIONES LEAL MORA SA', 'FU003019', 1, 1, 1, 1, '2020-12-31', 231432, 234, 23423, 3.3, 1.1, 0, 0, 0, 3, 'preuba11'),
(27, '900939798', ' RENTING AUTOMAYOR', 'CA000000', 3, 1, 1, 1, '2020-12-31', 54648500, 454, 65659, 5, 5, 0, 0, 0, 3, 'preueba21'),
(28, '800148973', ' COMPAÑIA TRANSPORTADORA ', 'CA001819', 1, 1, 1, 1, '2020-12-31', 23452300000, 356, 235345, 5, 5, 0, 0, 0, 3, 'prueba1234'),
(29, '860015118', ' CONTINAUTOS S.A', 'FU006420', 1, 1, 1, 1, '2020-12-31', 2352350, 345, 4564640, 8, 8, 0, 0, 0, 3, 'fdgsdfg');
...
CREATE TABLE IF NOT EXISTS `pay_obligation` (
  ...
  `pay_FixedRate` float NOT NULL DEFAULT 0,
  `pay_value` float NOT NULL,
  `pay_Dtf_points` float NOT NULL DEFAULT 0,
  `pay_Ibr_points` float NOT NULL DEFAULT 0,
  `pay_missing_cuotes` int(11) NOT NULL,
  `pay_interesting_value` float NOT NULL,
  `pay_capital_value` decimal(10,0) NOT NULL,
...
INSERT INTO `pay_obligation` (`pay_obligation_id`, `obligation_id`, `pay_obligation_actual_cuote`, `pay_Date`, `pay_Dtf`, `pay_Ibr`, `pay_FixedRate`, `pay_value`, `pay_Dtf_points`, `pay_Ibr_points`, `pay_missing_cuotes`, `pay_interesting_value`, `pay_capital_value`) VALUES
(1, 19, 300000, '2020-11-21 21:39:21', 0, 0, 0, 121, 0, 0, 1, 1, '1');
...
--
-- Filtros para la tabla `pay_obligation`
--
ALTER TABLE `pay_obligation`
  ADD CONSTRAINT `pay_obligation_ibfk_1` FOREIGN KEY (`obligation_id`) REFERENCES `obligation` (`obligation_id`);
